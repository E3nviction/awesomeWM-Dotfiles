...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "space",
              function () awful.util.spawn("rofi -show drun -theme /home/enviction/.config/rofi/launchers/type-4/style-1.rasi") end,
              {description = "show the app launcher", group = "awesome"})
)
